...
exports.Ch5BaseClassForCliCreate = void 0;
...
var Ch5BaseClassForCliCreate = /** @class */ (function () {
    function Ch5BaseClassForCliCreate() {
        this._folderPath = "";
        this._inputArgs = {};
        ...
        this._cliConfigFileReader = new Ch5CliConfigFileReader_1.Ch5CliConfigFileReader(path.join(this._folderPath, "files", "config.json"), JSON.parse(this._cliUtil.readFileContentSync(path.join(__dirname, "files", "environment.json"))));
        this.CONFIG_FILE = this._cliConfigFileReader.configFile;
        this.processArgs();
        this._cliLogger = new Ch5CliLogger_1.Ch5CliLogger(this._inputArgs["verbose"].inputValue);
    ...
    Object.defineProperty(Ch5BaseClassForCliCreate.prototype, "getEnquirer", {
        get: function () {
            return enquirer;
        },
        enumerable: false,
    ...
    Object.defineProperty(Ch5BaseClassForCliCreate.prototype, "getPrompt", {
        get: function () {
            return prompt;
        },
        enumerable: false,
    ...
    Object.defineProperty(Ch5BaseClassForCliCreate.prototype, "getSelect", {
        get: function () {
            return Select;
        },
        enumerable: false,
    ...
    Object.defineProperty(Ch5BaseClassForCliCreate.prototype, "getConfirm", {
        get: function () {
            return Confirm;
        },
        enumerable: false,
    ...
    Object.defineProperty(Ch5BaseClassForCliCreate.prototype, "inputArgs", {
        get: function () {
    ...
    Object.defineProperty(Ch5BaseClassForCliCreate.prototype, "utils", {
        get: function () {
    ...
    Object.defineProperty(Ch5BaseClassForCliCreate.prototype, "logger", {
        get: function () {
    ...
    Object.defineProperty(Ch5BaseClassForCliCreate.prototype, "configFileReader", {
        get: function () {
    ...
    Object.defineProperty(Ch5BaseClassForCliCreate.prototype, "configFile", {
        get: function () {
    ...
    Object.defineProperty(Ch5BaseClassForCliCreate.prototype, "configFileArgs", {
        get: function () {
            return this._cliConfigFileReader;
        },
        enumerable: false,
    ...
    Object.defineProperty(Ch5BaseClassForCliCreate.prototype, "namingHelper", {
        get: function () {
    ...
    Object.defineProperty(Ch5BaseClassForCliCreate.prototype, "projectConfig", {
        get: function () {
    ...
    Ch5BaseClassForCliCreate.prototype.processArgs = function () {
        var args = process.argv.slice(2);
        return this.processArgsAnalyze(args);
    };
    Ch5BaseClassForCliCreate.prototype.processArgsAnalyze = function (args) {
    ...
    Ch5BaseClassForCliCreate.prototype.mergeJSON = function () {
        var args = [];
    ...
    Ch5BaseClassForCliCreate.prototype.merger = function (target, obj) {
        for (var prop in obj) {
     ...
     * @param program
     */
    Ch5BaseClassForCliCreate.prototype.setupCommand = function (program) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.utils.readFileContent(path.join(this._folderPath, "files", "help.txt"))];
                    case 1:
    ...
    Ch5BaseClassForCliCreate.prototype.compareVersions = function (cliVersionInput, userVersionInput) {
    ...
    Ch5BaseClassForCliCreate.prototype.checkVersionToExecute = function () {
    ...
    Ch5BaseClassForCliCreate.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            var e_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        e_2 = _a.sent();
                        // Log error
                        this.getOutputResponse().errorMessage = this.logError(e_2);
                        return [3 /*break*/, 7];
                    case 6:
                        // Clean up
                        this.cleanUp();
    ...
    Ch5BaseClassForCliCreate.prototype.convertArrayToCommaSeparatedString = function (input) {
        var output = "";
     ...
     * DO NOT DELETE
     */
    Ch5BaseClassForCliCreate.prototype.initialize = function () { };
    Ch5BaseClassForCliCreate.prototype.verifyInputParams = function () {
        return __awaiter(this, void 0, void 0, function () { return __generator(this, function (_a) {
            return [2 /*return*/];
        }); });
    };
    Ch5BaseClassForCliCreate.prototype.checkPromptQuestions = function () {
        return __awaiter(this, void 0, void 0, function () { return __generator(this, function (_a) {
            return [2 /*return*/];
        }); });
    };
    Ch5BaseClassForCliCreate.prototype.processRequest = function () {
        return __awaiter(this, void 0, void 0, function () { return __generator(this, function (_a) {
            return [2 /*return*/];
        }); });
    };
    Ch5BaseClassForCliCreate.prototype.getOutputResponse = function () { };
    Ch5BaseClassForCliCreate.prototype.cleanUp = function () {
        return __awaiter(this, void 0, void 0, function () { return __generator(this, function (_a) {
            return [2 /*return*/];
        }); });
    };
    Ch5BaseClassForCliCreate.prototype.getCLIExecutionPath = function () { };
    Ch5BaseClassForCliCreate.prototype.showOutput = function () {
    ...
    Ch5BaseClassForCliCreate.prototype.getConfigNode = function (nodeName) {
     ...
     * @param  {...any} values
     */
    Ch5BaseClassForCliCreate.prototype.getText = function (key) {
        var _a;
        var values = [];
    ...
    Ch5BaseClassForCliCreate.prototype.logError = function (e) {
    ...
    Ch5BaseClassForCliCreate.prototype.isConfigFileValid = function (filePath, schemaFilePath, preBuildValidationOnly) {
    ...
    Ch5BaseClassForCliCreate.prototype.getFullPath = function () {
        var pathValue = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            pathValue[_i] = arguments[_i];
        }
        return path.resolve(path.normalize(path.join.apply(path, pathValue)));
    };
    Ch5BaseClassForCliCreate.prototype.isConfigFileExist = function (fileName) {
    ...
    Ch5BaseClassForCliCreate.prototype.getCurrentWorkingDirectory = function () {
        return process.cwd();
    };
    return Ch5BaseClassForCliCreate;
}());
exports.Ch5BaseClassForCliCreate = Ch5BaseClassForCliCreate;
