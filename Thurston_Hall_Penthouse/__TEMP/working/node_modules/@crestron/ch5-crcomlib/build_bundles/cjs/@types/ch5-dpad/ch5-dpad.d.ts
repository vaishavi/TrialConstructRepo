...
export declare class Ch5Dpad extends Ch5Common implements ICh5DpadAttributes {
    ...
    set hideCenterButton(value: boolean);
    get hideCenterButton(): boolean;
    set receiveStateHideCenterButton(value: string);
    get receiveStateHideCenterButton(): string;
    set disableCenterButton(value: boolean);
    get disableCenterButton(): boolean;
    set receiveStateDisableCenterButton(value: string);
    get receiveStateDisableCenterButton(): string;
    set useContractForDisableCenterButton(value: boolean);
    get useContractForDisableCenterButton(): boolean;
    set useContractForHideCenterButton(value: boolean);
    get useContractForHideCenterButton(): boolean;
    constructor();
    ...
    private updatePropertiesForHideAndDisableCenterButton;
