...
var Ch5ArchiveCli = /** @class */ (function () {
        ...
        program
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.archive(__assign(__assign({}, options), { projectName: options.projectName || this._cliUtil.getShellProjectPackageJson().name }))];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 3];
                    case 2:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, ch5_utilities_1.archiver)(configOptions)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    Ch5ArchiveCli.prototype.validateArchiveOptions = function (options) {
        ...
        throw new Error("Missing options: ".concat(missingOptions.join('. '), ". Type 'ch5-cli archive --help' for usage information."));
    };
